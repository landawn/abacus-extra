...
- minRowLength/maxRowLength only 2D (all primitives + ff Object[][]); none 3D (fff). elementCount has both 2D(ff 22018)+3D(fff 23545). Asymmetry vs elementCount.
