...
[![Javadocs](https://img.shields.io/badge/javadoc-3.6.9-brightgreen.svg)](https://www.javadoc.io/doc/com.landawn/abacus-extra/3.6.9/index.html)
...
```gradle
// JDK 17 or above:
compile 'com.landawn:abacus-extra:3.6.9'
```
