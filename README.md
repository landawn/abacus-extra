...
[![Javadocs](https://img.shields.io/badge/javadoc-2.26.6-brightgreen.svg)](https://www.javadoc.io/doc/com.landawn/abacus-extra/2.26.6/index.html)
...
```gradle
// JDK 17 or above:
compile 'com.landawn:abacus-extra:2.26.6'
```
