...
[![Javadocs](https://img.shields.io/badge/javadoc-1.9.0-brightgreen.svg)](https://www.javadoc.io/doc/com.landawn/abacus-extra/1.9.0/index.html)
...
```gradle
// JDK 1.8 or above:
compile 'com.landawn:abacus-extra:1.9.0'
```
