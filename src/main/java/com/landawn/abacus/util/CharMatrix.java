...
public final class CharMatrix extends AbstractMatrix<char[], CharList, CharStream, Stream<CharStream>, CharMatrix> {
     ...
     * @throws E the e
     */
    public <T, E extends Exception> Matrix<T> mapToObj(final Class<T> targetElementType, final Throwables.CharFunction<? extends T, E> func) throws E {
     ...
     */
    @Override
    public <E extends Exception> void flatOp(Throwables.Consumer<char[], E> op) throws E {
        Arrays.flatOp(a, op);
    }
