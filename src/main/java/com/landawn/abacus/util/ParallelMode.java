 ...
 * <ul>
 *   <li>{@link #FORCE_ON} - Forces parallelization regardless of matrix size; use when
 *       you know operations will benefit from parallel processing.</li>
 *   <li>{@link #FORCE_OFF} - Forces sequential execution; use for deterministic behavior
 *       or when integrating with non-thread-safe code.</li>
 *   <li>{@link #AUTO} - Automatically decides based on matrix size and operation
...
public enum ParallelMode {
     ...
     *
     * // Even small matrices will be processed in parallel when FORCE_ON is set
