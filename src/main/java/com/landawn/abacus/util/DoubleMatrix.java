...
public final class DoubleMatrix extends AbstractMatrix<double[], DoubleList, DoubleStream, Stream<DoubleStream>, DoubleMatrix> {
     ...
     * @throws E the e
     */
    public <T, E extends Exception> Matrix<T> mapToObj(final Class<T> targetElementType, final Throwables.DoubleFunction<? extends T, E> func) throws E {
     ...
     */
    @Override
    public <E extends Exception> void flatOp(Throwables.Consumer<double[], E> op) throws E {
        Arrays.flatOp(a, op);
    }
