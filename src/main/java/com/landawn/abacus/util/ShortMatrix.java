...
public final class ShortMatrix extends AbstractMatrix<short[], ShortList, ShortStream, Stream<ShortStream>, ShortMatrix> {
     ...
     */
    public void copyFrom(final int targetStartRowIndex, final int targetStartColumnIndex, final short[][] b) throws IllegalArgumentException {
     ...
     * <pre>{@code
     * ShortMatrix matrix = ShortMatrix.of(new short[][] {{1, 2}, {3, 4}});
     * ShortMatrix extended = matrix.resize(3, 4, (short) 9);   // Extend to 3x4, fill new cells with 9
     * // Result: [[1, 2, 9, 9],
     * //          [3, 4, 9, 9],
     * //          [9, 9, 9, 9]]
     *
     * // Truncate to smaller size
     * ShortMatrix truncated = matrix.resize(1, 1, (short) 0);   // Keep only top-left element
     * // Result: [[1]]
     * }</pre>
     *
     * @param newRowCount the number of rows in the new matrix. It can be smaller than the row number of the current matrix but must be non-negative
