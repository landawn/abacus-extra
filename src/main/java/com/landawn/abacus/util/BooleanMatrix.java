...
public final class BooleanMatrix extends AbstractMatrix<boolean[], BooleanList, Stream<Boolean>, Stream<Stream<Boolean>>, BooleanMatrix> {
     ...
     * @throws E the e
     */
    public <T, E extends Exception> Matrix<T> mapToObj(final Class<T> targetElementType, final Throwables.BooleanFunction<? extends T, E> func) throws E {
     ...
     */
    @Override
    public <E extends Exception> void flatOp(Throwables.Consumer<boolean[], E> op) throws E {
        Arrays.flatOp(a, op);
    }
